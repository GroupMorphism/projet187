INSERT INTO Cuve (idCuvee, Responsable, debut, fin, idRecette) VALUES
...
('GCFGGTRT', 'visseur automatisé','Y4BWW901','ABCD'),
('ACBTHJKB', 'cuve à liquide','GZB48901','CZBB');
...
('EEEE','2022-06-11-2022-06-12','2022-06-11','On introduit le houblon dans les cuves','UUBB'),
('BBBB','2021-08-11-2021-08-12','2021-08-11','On laisse maturer le liquide dans les cuves','UURF');
